...
def test_convert_model_hummingbird_onnx():
    ...
    """
    assert isinstance(model_converter.convert_model_hummingbird("onnx", 1), ONNXSklearnContainerClassification)
...
def test_convert_model_hummingbird_pytorch():
    ...
    """
    assert isinstance(model_converter.convert_model_hummingbird("pytorch", 1), PyTorchSklearnContainerClassification)
...
def test_convert_model_hummingbird_torch():
    ...
    """
    assert isinstance(model_converter.convert_model_hummingbird("torch", 1), PyTorchSklearnContainerClassification)
